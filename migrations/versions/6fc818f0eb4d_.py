...
Revision ID: 6fc818f0eb4d
Revises: 452e39dc19d4
Create Date: 2021-07-01 17:47:37.667113
...
revision = '6fc818f0eb4d'
down_revision = '452e39dc19d4'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('seeking_talent_description', sa.VARCHAR(length=500), autoincrement=False, nullable=True),
    ...
    sa.Column('seeking_venue_description', sa.VARCHAR(length=500), autoincrement=False, nullable=True),
    sa.Column('genres', postgresql.ARRAY(sa.VARCHAR(length=120)), autoincrement=False, nullable=True),
